...
@section('title', 'Tambah Supplier | MakanBang')
@section('content')

<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Supplier /</span> Tambah Data Supplier</h4>
<div class="col-xl">
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Supplier</h5>
        <small class="text-muted float-end">Tambah Supplier</small>
      </div>
      <div class="card-body">
